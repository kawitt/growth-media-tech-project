...
[Subtask 1 Solution]({{< relref "/growth-media-technology-project/subtask1" >}})

> The value parameter should be Order Subtotal (which should not include a currency symbol or any commas).

2. Set `transaction_id` parameter to **Order Number**.   

[Subtask 2 Solution]({{< relref "/growth-media-technology-project/subtask2" >}})

> Revenue is only showing up for orders less than $1,000

3. Ensure all revenue amounts are showing.

[Subtask 3 Solution]({{< relref "/growth-media-technology-project/subtask3" >}})

> orders are being duplicated.

4. Prevent collection of duplicate orders. 

[Subtask 4 Solution]({{< relref "/growth-media-technology-project/subtask4" >}})
...
[Subtask 5 Solution]({{< relref "/growth-media-technology-project/subtask5" >}})